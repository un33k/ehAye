...
main() {
    ...
    echo "  2. Download models: ali mod search -q phi → ali mod download -m phi3:mini"
    echo "  3. Start chatting: ali chat interactive"
    echo "  4. Run benchmarks: ali perf validate"
    echo ""
    echo "Available commands:"
    echo "  • ali mod          - Model management"
    echo "  • ali chat         - Interactive chat interface"
    echo "  • ali perf         - Performance benchmarking"
