...
from ehaye.models.categories import ModelInfo
from ehaye.models.registry import ModelRegistry
from ehaye.models.manager import ModelManager
...
class TestModelWorkflow:
    ...
    def test_model_info_consistency(self, test_config):
        ...
        from ehaye.models.categories import categorize_model
